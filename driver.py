...
# Hier naiver Ansatz ohne Multiprocessing.

# for instance_name, population_size, mutation_rate, sgs in itertools.product(instance_names,population_sizes, mutation_rates,
#                                                                             schedule_generation_schemes
#                                                                             ):
#     print("---------- Starting Run -----------")
...
#     if sgs == "serial":
#         scheduling_project.solve_instance_via_ga(population_size, int(computation_limit_SGS/population_size), mutation_rate, scheduling_project.serial_SGS)
#     elif sgs == "parallel":
#         scheduling_project.solve_instance_via_ga(population_size, int(computation_limit_SGS/population_size), mutation_rate, scheduling_project.parallel_SGS)
#
#     print("---------- Finished Run -----------\n\n")
